...
before_honolulu = before_hawaii[2].partition(
        b'</span></dd>\n<dd><span class="label">Honolulu County:</span> <span class="value">')
before_kauai = before_honolulu[2].partition(
        b'</span></dd>\n<dd><span class="label">Kaua&#8217;i County:</span> <span class="value">')
before_maui = before_kauai[2].partition(
...
#     schedule.every(30).seconds.do(post)
#
#     while True:
